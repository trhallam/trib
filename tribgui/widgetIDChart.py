...
class widgetFDChart(QtWidgets.QWidget, qdesignFDChart.Ui_Form):
    def __init__(self, parent=None):
        ...
        self.comboBoxDistr.addItem("Normal"); self.comboBoxDistr.addItem("Log-Normal")
        ...
        self.spinBoxDistr.setDisplayIntegerBase(1)
        self.spinBoxDistr.setObjectName("spinBoxDistr")
        self.horizontalLayout.insertWidget(4,self.spinBoxDistr)
...
#        self.setAxesMinMax(-3,3,0.01,1.5)
    ...
    @pyqtSlot(str)
    def onComboBoxDistrChanged(self, type):
        self.activeDist = type
        print(self.activeDist)
